...
export function Viagem() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Sugira uma viagem detalhada de ${ocasiao}, no país ${ingr1}, com um clima ${ingr2}, durante a temporada ${ingr3} do ano, com o valor máximo a ser gasto de ${ingr4} reais.`;
  ...
  return (
    <View style={ESTILOS.container}>
      ...
      <Text style={ESTILOS.header}>Ideia de Viagem</Text>
      <View style={ESTILOS.form}>
        ...
        />
        <TextInput
          placeholder="Modo (Ex: ônibus, avião...)"
          style={ESTILOS.input}
          value={ocasiao}
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 24, marginTop: 4, }} style={ESTILOS.containerScroll} showsVerticalScrollIndicator={false} >
        {load && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Produzindo viagem...</Text>
